    ...
    <body>
            ...
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
                <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap">Registro de Entrega de EPP</span>
                </a>
            ...
            <div class="max-w-screen-xl px-4 py-3 mx-auto">
                <div class="flex items-center">
                    <ul class="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
                        <li>
                            <a href="/epp" class="{{ request()->is('epp*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Inicio
                            </a>
                        </li>    
                        <li>
                            <a href="/empleado" class="{{ request()->is('empleado*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Empleados
                            </a>
                        </li>
                        <li>
                            <a href="/equipo" class="{{ request()->is('equipo*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Lista de Equipo de Protección Personal
                            </a>
                        </li>
                        <li>
                            <a href="/puestos-epp" class="{{ request()->is('puestos-epp*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Asignación de EPP por puesto de trabajo
                            </a>
                        </li>
                        <li>
                            <a href="/epp/requeridos" class="{{ request()->is('epp/requeridos*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Necesidades de EPP
                            </a>
                        </li>
                        <li>
                            <a href="/controlentrega" class="{{ request()->is('controlentrega*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Control de Entrega de EPP
                            </a>
                        </li>
                        <li>
                            <a href="/consultas" class="{{ request()->is('consultas*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Consultar Historial
                            </a>
                        </li>
                        <li>
                            <a href="/epp-obligatorios" class="{{ request()->is('epp-obligatorios*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
