...
<body class="bg-slate-50 text-slate-800">
      ...
      <div class="flex items-center gap-2">
        ...
        <a href="/" class="flex items-center gap-3">
          ...
          <div class="leading-tight">
            ...
            <p class="text-lg font-semibold">Registro de Entrega de EPP</p>
          </div>
        </a>
      </div>
    ...
    <div class="h-full flex flex-col">
      ...
      <nav class="flex-1 overflow-y-auto scrollbar-thin px-2 py-3">
        ...
        <ul class="space-y-1">
          <li>
            <a href="/epp"
               class="group flex items-center gap-3 rounded-xl px-3 py-2 {{ $activeLink('epp*') }}">
              <!-- home -->
          ...
          <li class="mt-4 px-2 text-xs font-semibold tracking-wide text-slate-500">Gestión</li>
          ...
          <li>
            <a href="/equipo" class="group flex items-center gap-3 rounded-xl px-3 py-2 {{ $activeLink('equipo*') }}">
              <!-- shield/checklist -->
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6l7 4v4a7 7 0 11-14 0V10l7-4z"/>
              </svg>
              <span class="text-sm font-medium">Lista de EPP</span>
            </a>
          </li>

          <li>
            <a href="/puestos-epp" class="group flex items-center gap-3 rounded-xl px-3 py-2 {{ $activeLink('puestos-epp*') }}">
              <!-- briefcase -->
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <li>
            <a href="/epp/requeridos" class="group flex items-center gap-3 rounded-xl px-3 py-2 {{ $activeLink('epp/requeridos*') }}">
              <!-- sparkles -->
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span class="text-sm font-medium">Necesidades de EPP</span>
            </a>
          </li>

          <li class="mt-4 px-2 text-xs font-semibold tracking-wide text-slate-500">Operación</li>

          <li>
            <a href="/controlentrega" class="group flex items-center gap-3 rounded-xl px-3 py-2 {{ $activeLink('controlentrega*') }}">
              <!-- clipboard check -->
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4M9 4h6M7 4h10a2 2 0 012 2v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6a2 2 0 012-2z"/>
              </svg>
              <span class="text-sm font-medium">Control de Entrega</span>
            </a>
          </li>

          <li>
            <a href="/consultas" class="group flex items-center gap-3 rounded-xl px-3 py-2 {{ $activeLink('consultas*') }}">
              <!-- search -->
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span class="text-sm font-medium">Consultar Historial</span>
            </a>
          </li>

          <li>
            <a href="/epp-obligatorios" class="group flex items-center gap-3 rounded-xl px-3 py-2 {{ $activeLink('epp-obligatorios*') }}">
              <!-- exclamation circle -->
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <script>
    (function () {
      ...
      const KEY = 'sidebarHidden';                // misma preferencia para todos los módulos
