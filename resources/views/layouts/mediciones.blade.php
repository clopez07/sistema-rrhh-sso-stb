    ...
    <body>
            ...
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
                <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap">Resultado de Mediciones Ruido e Iluminación</span>
                </a>
            ...
            <div class="max-w-screen-xl px-4 py-3 mx-auto">
                <div class="flex items-center">
                    <ul class="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
                        <li>
                            <a href="/estandarilu" class="{{ request()->is('estandarilu*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Estándares
                            </a>
                        </li>      
                        <li>
                            <a href="/localizacion" class="{{ request()->is('localizacion*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Localizaciones
                            </a>
                        </li>    
                        <li>
                            <a href="{{ route('mediciones.captura') }}" class="{{ request()->is('#*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Hoja de Campo de Mediciones
                            </a>
                        </li>
                        <li>
                            <a href="/mediciones/iluminacion/reporte" class="{{ request()->is('#*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Resultados de Mediciones de Iluminación
                            </a>
                        </li>
                        <li>
                            <a href="/mediciones/ruido/reporte/accion" class="{{ request()->is('#*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Resultados de Mediciones de Ruido
                            </a>
                        </li>
                        <li>
                            <a href="/mediciones/timeline" class="{{ request()->is('#*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Línea de Tiempo de Mediciones
                            </a>
                        </li>
                        <li>
                            <a href="/mediciones/graficas" class="{{ request()->is('#*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
