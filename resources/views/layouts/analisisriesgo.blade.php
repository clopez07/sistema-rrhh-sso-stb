            ...
            <div class="max-w-screen-xl px-4 py-3 mx-auto">
                <div class="flex items-center">
                    <ul class="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
                        ...
                        <li>
                            <a href="/verificacion" class="flex items-center justify-between w-full py-2 px-3 font-medium text-gray-900 border-b border-gray-100 md:w-auto hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0">
                        ...
                        <li>
                         ...
                         <li>
                            <button id="matriz-button" type="button" class="flex items-center justify-between w-full py-2 px-3 font-medium text-gray-900 border-b border-gray-100 md:w-auto hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0">Notificación de Riesgos
                            <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                            </svg>
                            </button>
            ...
            <div id="datos-dropdown" class="hidden mt-1 bg-white border-gray-200 shadow-xs border-y">
                <div class="grid max-w-screen-xl px-4 py-5 mx-auto text-gray-900 sm:grid-cols-2 md:grid-cols-3 md:px-6">
                    <ul aria-labelledby="datos-button">
                        ...
                        <li>
                            <a href="/estandarilu" class="block p-3 rounded-lg hover:bg-gray-50">
                                <div class="font-semibold">Valores Estándares de Medición</div>
                                <span class="text-sm text-gray-500">Valores estándar aceptables de iluminación, ruido y temperatura según las normas.</span>
                            </a>
                        </li>
                        </ul>
                        <ul aria-labelledby="datos-button">
                        <li>
                            <a href="/detallesriesgo" class="block p-3 rounded-lg hover:bg-gray-50">
                                <div class="font-semibold">Información de Identificación de Riesgos</div>
                                <span class="text-sm text-gray-500">Riesgos existentes para cada puesto de Trabajo.</span>
                            </a>
                        </li>
                        <li>
                            <a href="/evaluacionriesgos" class="block p-3 rounded-lg hover:bg-gray-50">
                                <div class="font-semibold">Información de Evaluación de Riesgos</div>
                                <span class="text-sm text-gray-500">Evaluación de cada riesgo por cada puesto de trabajo, desde irrelevante hasta muy alto.</span>
                            </a>
                        </li>
                        <li>
                            <a href="/riesgopuesto" class="block p-3 rounded-lg hover:bg-gray-50">
                                <div class="font-semibold">Información de Riesgos para Matriz</div>
                                <span class="text-sm text-gray-500">Valores estándar aceptables de iluminación, ruido y temperatura según las normas.</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul aria-labelledby="formatos-button">
                        <li>
                            <a href="#" class="block p-3 rounded-lg hover:bg-gray-50">
                                <div class="font-semibold">Identificación de Riesgos</div>
                                <span class="text-sm text-gray-500">Formato de Identificación de Riesgos por Puesto de Trabajo.</span>
                            </a>
                        </li>
                        <li>
                        <a href="#"
                            ...
                            <span class="text-sm text-gray-500">Formato de Evaluación de Riesgos por Puesto de Trabajo.</span>
                        </a>
                        </li>

                        <li>
                            <a href="#" class="block p-3 rounded-lg hover:bg-gray-50">
                                <div class="font-semibold">Plan de Acción Control de Riesgos Identificados</div>
                                <span class="text-sm text-gray-500">Medidas físicas implementadas para eliminar o reducir riesgos.</span>
                            </a>
                        </li>
                    </ul>
                    <ul aria-labelledby="datos-button">
                        <li>
                            <a href="#" class="block p-3 rounded-lg hover:bg-gray-50">
                                <div class="font-semibold">Notificación de Riesgos por Persona</div>
                                <span class="text-sm text-gray-500">Formato de notificación de riesgos por puesto de trabajo para una sola persona.</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="block p-3 rounded-lg hover:bg-gray-50">
                                <div class="font-semibold">Notificación de Riesgos por Puestos de Trabajo</div>
                                <span class="text-sm text-gray-500">Formato de notificación de riesgos por puesto de trabajo para una sola persona.</span>
                            </a>
                        </li>
                    </ul>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('[data-modal-target="'+modalId+'"]').forEach(trigger => {
    trigger.addEventListener('click', loadPuestos);
  });
