        ...
        <nav class="bg-white border border-gray-400 rounded-md">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
                <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap">Registro de Asistencia a Capacitaciones</span>
                </a>
            ...
            <div class="max-w-screen-xl px-4 py-3 mx-auto">
                <div class="flex items-center">
                    <ul class="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
                        <li>
                            <a href="/Capacitaciones" class="{{ request()->is('Capacitaciones*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Inicio
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/detallescapacitacion" class="{{ request()->is('detallescapacitacion*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Detalles de Capacitaciones
                            </a>
                        </li>
                        <li>
                            <a href="/puestos-capacitacion" class="{{ request()->is('puestos-capacitacion*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Asignación de capacitación por puesto
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/consultascapacitaciones" class="{{ request()->is('consultascapacitaciones*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Consultas
                            </a>
                        </li>
                        <li>
                            <a href="/capacitaciones-obligatorias" class="{{ request()->is('capacitaciones-obligatorias*') ? 'text-blue-600 underline font-semibold' : 'text-gray-900 hover:underline' }}">
                                Ver Capacitaciones Pendientes
                            </a>
                        </li>
                    </ul>
                </div>
