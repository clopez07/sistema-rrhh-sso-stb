...
@section('content')
    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li class="inline-flex items-center">
        <a href="/estandares" class="inline-flex items-center text-sm font-medium text-black hover:text-blue-900">
            <!-- Ícono de inicio -->
            ...
            <tbody>
                ...
                <tr class="bg-white border-b border-gray-200 hover:bg-gray-50">
                    ...
                    <td class="flex items-center px-6 py-4">
                        <button data-modal-target="edit-modal" data-modal-toggle="edit-modal" class="font-medium text-blue-600 hover:underline">Editar</button>
                        ...
                        <div id="edit-modal-{{ $estandarilum->id_estandar_iluminacion }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                ...
                                <div class="relative bg-white rounded-lg shadow-sm">
                                    ...
                                    <!-- Modal body -->
                                    <form action="{{ route('senalizacion.updatesenalizacion', $estandarilum->id_estandar_iluminacion) }}" method="POST" class="p-4 md:p-5">
                                        @csrf
                                        @method('PUT')
                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                            <div class="col-span-2">
                        ...
                        <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="font-medium text-red-600 hover:underline ms-3">Eliminar</button>
