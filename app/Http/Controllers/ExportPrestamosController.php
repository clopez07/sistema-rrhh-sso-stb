...
prod_dates AS (
    -- Fechas de PRODUCCIÓN en rango, sin 15 ni fin de mes
...
qslots AS (
    -- Solo dos slots: la MÍNIMA y la MÁXIMA de PRODUCCIÓN (si solo hay una, habrá un slot)
...
SELECT
    ...
    `SALDO PAGADO`, `SALDO RESTANTE`, `INTERESES PAGADOS`, `INTERESES RESTANTES`,
...
SELECT
    ...
    SUM(`SALDO PAGADO`), SUM(`SALDO RESTANTE`), SUM(`INTERESES PAGADOS`), SUM(`INTERESES RESTANTES`),
